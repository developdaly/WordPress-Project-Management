				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<div id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
						...
						<div class="post-header text-center">
							...
							<?php echo apply_atomic_shortcode( 'byline', '<div class="byline">' . __( 'by [entry-author] on [entry-published]<br /> last updated by '. get_the_modified_author() .' on <abbr class="published" title="'. get_the_modified_time('l, F jS, Y, g:i a') .'">'. get_the_modified_time( ' F jS, Y' ) .'</abbr>', hybrid_get_parent_textdomain() ) . '</div>' ); ?>
